...
class AsyncEventLoop:
    ...
    def send_async_message(
        ...
        self.transport.send_message(
            PipeMessage(src_rank, dst_rank, queue_name=EVENT_LOOP_QUEUE, args=body, tensors=tuple(input)), sync=True,
        )
    ...
    def run_invocation(
        ...
        if invocation.dest and invocation.dest.stage != invocation.this.stage:
            ...
            self.send_async_message(this_rank, ranks[invocation.dest.stage], [*result], batch.index, invocation)
